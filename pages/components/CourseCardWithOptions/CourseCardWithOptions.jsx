  ...
  return (
    <>
      ...
      <div  className={css.outerDiv} onClick={()=>{
            // navigate(path,{state:{courseVid:id}})
            navigate.push(path);
             sessionStorage.setItem("courseVid",id)
      }}>
        {isOptions ? (
          <div
          ...
          >
            ...
            >
              <img src={"/publicContent/icons/dots.png"} className={css.menuIcon} id={`cwo-${id}`} />
              {menuBox ? (
        ...
        <div className={css.imgBox}>
          ...
          <div className={css.hovImgBox}>
            <img src={"/publicContent/icons/play-button.png"} alt="play icon" className={css.hovImg} />
          </div>
        </div>
        <div className={css.bdy}>
          <div className={css.ttl}>
             <div dangerouslySetInnerHTML={{__html:ttl}}></div>
          </div>
